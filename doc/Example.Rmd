...
```{r taxa_join}
query <- 'select distinct taxa.taxon_name,occurrences.decimal_latitude,occurrences.decimal_longitude
from (((taxonvariants 
...
```{r pic}
# collapse unbranched interior nodes (these are the result of taking a subtree from the database)
tree <- collapse.singles(tree)

# convert from multifurcating to bifurcating (the tree in the database may not be fully resolved)
tree <- multi2di(tree)
